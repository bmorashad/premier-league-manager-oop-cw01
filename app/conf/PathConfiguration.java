...
public class PathConfiguration {
	public static final String DEV_FOLDER = "app"; 
	...
	static {
		...
		int indexOfProjectRootFolder = Arrays.asList(folders).lastIndexOf(DEV_FOLDER);
		PROJECT_ROOT = String.join(pathSeparator, Arrays.copyOfRange(folders, 0, indexOfProjectRootFolder)) + pathSeparator;
